...
- Provide a single, immutable config object
"""
...
def _read_yaml(file_path: str) -> Dict[str, Any]:
    """
    Read a YAML file and returns its contents.
...
def load_config() -> Dict[str, Any]:
    ...
    # common_config = _read_yaml(common_path)
    common_config = _read_yaml(COMMON_CONFIG_PATH)
